    ...
    else
    {
        ...
        if (sess_role.equals("1")){
            out.println("<script language=\"javascript\">alert('你無權限操作'); window.location.href = 'salepage.jsp'; </script>");
                ...
                String sess_id = Integer.toString((Integer) session.getAttribute("sess_userid")) ;
...
<html>
    ...
    <body>
        ...
        <form method="post" action="admin_update_process.jsp" class="add-item">
            ...
            <div class="container py-3">
                <div class="row justify-content-around">
                    <div class="col-4">
                        ...
                        <%
                            if (sess_id.equals(id)){out.print("<a href=\"admin_change_passwd.jsp?userid="+id+"\">更改密碼</a>");}
                            else if (role.equals("標準使用者")){out.print("<a href=\"admin_change_passwd.jsp?userid="+id+"\">更改密碼</a>");}
                        %>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-3">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div>
                        <button type="button" class="btn btn-outline-dark" onclick="location.href='admin_user.jsp'">上一頁</button>
                    </div>
                </div>
            </div>
        </form>
