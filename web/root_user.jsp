    ...
    else
    {
        ...
        if (role.equals("1")){
            ...
            try{
                ...
                String sql = "SELECT `user_name`,`account`,`role`,`sale_name`,`phone`,`email`,`ban` ,`user_id`FROM `user_list`,`sale_list` WHERE user_list.sale_id=sale_list.sale_id ";
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            ...
            <ul class="nav justify-content-end">
                <li class="nav-item active">
                    <button type="button" class="btn btn-info" onclick="location.href='root_add.jsp'">新增資料<span class="sr-only">(current)</span></button>
                </li>
                <li class="nav-item active">
        ...
        <table id="contentTable" class="table table-bordered table-striped text-center table-hover table-condensed" style="font-size:20px; width:100%">
            ...
            <tr>
                ...
                %></td>
                <td align="center"><a href="root_update.jsp?id=<%=rs.getString(8)%>">修改</a></td>
                <td align="center"><a href="root_delete.jsp?id=<%=rs.getString(8)%>">刪除</a></td>
        ...
        <div class="row justify-content-center align-items-center py-3">
            <div col order-2>
                <button type="button" class="btn btn-outline-dark" onclick="location.href='root_user.jsp'">置頂</button>
            </div>
            <div class="col-md-1"></div>
            <div col order-1>
                <button type="button" class="btn btn-outline-dark" onclick="location.href='root.jsp'">上一頁</button>
            </div>
        </div>
