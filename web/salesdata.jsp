...
//建立statement
                ...
                {
//建立SQL查詢
                    String sql="select * from sale_data natural join sale_list";
...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            ...
            <ul class="nav justify-content-end">
                <li class="nav-item active">
                    <button type="button" class="btn btn-info" onclick="location.href='insert_test.jsp'">新增資料<span class="sr-only">(current)</span></button>
                </li>
                <li class="nav-item active">
        ...
        <table id="contentTable" class="table table-bordered table-striped text-center table-hover table-condensed" style="font-size:20px; width:100%">
            <thead>
                <tr>
                    <th style="width:9%;">報備日期</th>
                    <th style="width:9%;">客戶名稱</th>
                    <th style="width:9%;">客戶聯絡人</th>
                    <th style="width:9%;">客戶聯絡人電話</th>
                    <th style="width:9%;">經銷商</th>
                    <th style="width:9%;">經銷商聯絡人</th>
                    <th style="width:10%;">經銷商聯絡人電話</th>
                    <th style="width:9%;">人臉辨識機數量</th>
                    <th style="width:10%;">熱成像測溫機數量</th>
                    <th style="width:7%;">目前狀態</th>
            ...
            <tr>
                ...
                <td align="center"><%=rs.getString("client_name")%></td>
                <td align="center"><%=rs.getString("client_contact")%></td>
                <td align="center"><%=rs.getString("client_phone")%></td>
                ...
                <td align="center"><%=rs.getString("face_num")%></td>
                <td align="center"><%=rs.getString("hot_num")%></td>
                <td align="center"><%=rs.getString("state")%></td>
                <td align="center"><a href="sale_update.jsp?client_name=<%=rs.getString("client_name")%>">修改</a></td>
            </tr>
            <%
                }
            %>
        ...
        <div class="row justify-content-center align-items-center py-3">
            <div col order-2>
                <button type="button" class="btn btn-outline-dark" onclick="location.href='salesdata.jsp'">置頂</button>
            </div>
